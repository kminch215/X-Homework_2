...
public class StudentManager {	
	public static void main(String[] args) {
		...
		studentManager.displayStudents()package edu.mu;
...
public class StudentManager {	
	public static void main(String[] args) {
		try {
			Scanner fileIn = new Scanner(new FileInputStream("edu/studentData.txt"));
			...
			fileIn = new Scanner(new FileInputStream("edu/studentData.txt"));
